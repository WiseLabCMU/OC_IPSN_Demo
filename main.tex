...
In this demonstration, we first present OpenChirp, an open-source Low-Power
...
With a focus to further enable research on the wireless physical layer, we also
...
Next, we describe some of its important components.
