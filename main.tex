...
\author{
	\IEEEauthorblockN{Adwait Dongare, Anh Luong, Artur Balanuta, Craig Hesling, Khushboo Bhatia,\\Bob Iannucci, Swarun Kumar, Anthony Rowe}
	\IEEEauthorblockA{
...
\author{
    \IEEEauthorblockN{  Adwait Dongare\IEEEauthorrefmark{1},
                        Anh Luong\IEEEauthorrefmark{1},
                        Artur Balanuta\IEEEauthorrefmark{1}\IEEEauthorrefmark{2},
                        Craig Hesling\IEEEauthorrefmark{1},
                        Khushboo Bhatia\IEEEauthorrefmark{1},\\
                        Bob Iannucci\IEEEauthorrefmark{1},
                        Swarun Kumar\IEEEauthorrefmark{1} and
                        Anthony Rowe\IEEEauthorrefmark{1}}
    \IEEEauthorblockA{
        \IEEEauthorrefmark{1}Electrical and Computer Engineering Department, Carnegie Mellon University, Pittsburgh PA\\
        \IEEEauthorrefmark{2}Instituto Superior T\'ecnico, University of Lisbon, Lisbon, Portugal\\
        Email: \{adongare, aluong, arturb, jhesling, khushbob, roberti, swarunk, agr\}@andrew.cmu.edu
        % adongare@cmu.edu,
        % aluong@cmu.edu,
        % artur@cmu.edu,
        % hesling@cmu.edu,
